...
$servers = @(
    @{ module = "super_agent.tool.mcp_servers.browser_use_mcp_server"; args = "" },
    @{ module = "super_agent.tool.mcp_servers.python_server"; args = "" },
    @{ module = "super_agent.tool.mcp_servers.vision_mcp_server"; args = "" },
    @{ module = "super_agent.tool.mcp_servers.audio_mcp_server"; args = "" },
    @{ module = "super_agent.tool.mcp_servers.reasoning_mcp_server"; args = "" },
    @{ module = "super_agent.tool.mcp_servers.reading_mcp_server"; args = "--transport sse" },
    @{ module = "super_agent.tool.mcp_servers.searching_mcp_server"; args = "" },
    @{ module = "super_agent.tool.mcp_servers.wiki_mcp_server"; args = "" }
    
)

$repoRoot = Resolve-Path (Join-Path $PSScriptRoot '..\..\..\..\..')
$toolingDir = Join-Path $repoRoot "super_agent\tool"
